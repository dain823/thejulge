// src/components/owner/JobPostFormClient.tsx
// 이 파일은 'use client' 지시문이 맨 위에 있어야 합니다.
'use client';

import { Suspense } from 'react'; // Suspense는 이 컴포넌트 내부에 직접 사용되지 않아도 되지만, 혹시 모를 내부 컴포넌트 사용을 위해 남겨둡니다.
...
export default function JobPostFormClient() {
  ...
  return (
    // JobPostFormClient 내부의 Suspense는 제거됩니다.
    // Suspense는 이제 page.tsx에서 감싸는 역할을 합니다.
